...
<div class="container-fluid">
    <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-0">
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom page-title-div px-3">
                <h5 class="title_page">Dashboard > Category</h5>
            </div>
            <div class="row mx-3">
                <div class="col-md-12">
                   <?=$this->session->flashdata('notification')?>
                    <div class="card card_backgroud">
                      <div class="card-header d-flex justify-content-between align-items-center"><label class="card-title">Category</label>
                    <a href="<?=base_url()?>admin/Create-Category" class="btn btn-primary">Create Category</a>
                      </div>
                      <div class="card-body">
                          <div class="row">
                              <div class="col-md-12">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><center><a class="btn btn-warning btn-sm" href="<?=base_url()?>admin/Edit-Category/<?=$val->CategoryId?>"><i class="fas fa-pen"></i></a>
